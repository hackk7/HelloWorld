 ...
 * @date 2023/11/1
 */
public class GenerateHtml2 {

    static String htmlCode = "";

    public static void main(String[] args) throws Exception {

        generate("/Users/mark/Desktop/note/English/GaoZhong_1.md");
    ...
    private static void generate(String file) throws Exception {
        ...
        for (String line : allLines) {
            ...
            // 转换成html元素
            String handler = transformHtmlElement(substring, String.valueOf(tabIndex += 1), split.length > 1 ? split[1] : "");
            // 添加到html元素集合中
